    ...
    return (
         <div>    
            ...
            <div className=" h-screen w-screen bg-white relative flex flex-col-reverse px-4 py-16 mx-auto lg:block lg:flex-col lg:py-32 xl:py-48 md:px-8">
                <div className="z-0 flex justify-center h-full  overflow-hidden   xl:pr-0 lg:w-1/2 lg:absolute lg:justify-end lg:bottom-0 lg:left-0 lg:items-center">
                    <div className="bg-[url('/assets/navbar/hero-background.png')]  bg-cover bg-top bg-no-repeat max-w-7xl mx-auto grid  grid-cols-1 text-center lg:grid-cols-2 lg:text-left gap-4 p-5  px-4 ">
                        <div className="mx-auto">
                            <h1 data-tilt style={{lineHeight : '120%'}} className="pt-20 text-white font-customsemibold lg:text-4xl md:text-3xl text-2xl pb-6">
                                Easy. Flexible.
                                <br></br>Analytics for 
                                Web | SAAS</h1>
