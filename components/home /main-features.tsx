...
export default function TopFeaturesSection(){
    return (
         <div>
                ...
                <div  className="  text-white mb-12   mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl  lg:py-20">
                 
                    <div className="  shadow-xl sm:p-2 mb-12">
                        <div className="flex  flex-col lg:flex-row">
                            <div className="   bg-[#1c1c1c] py-12 px-6 mb-6 lg:mb-0 lg:w-1/2 lg:pr-5">
                                <img src="/assets/home/dashboard.png" />
                            </div>
                            <div className=" bg-[#161616] py-24 px-6 lg:w-1/2">
                    ...
                    <div className=" rounded shadow-xl sm:p-2 mb-12">
