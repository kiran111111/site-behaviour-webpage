    ...
    return(
              ...
              <div className="px-4 mt-96 py-16 bg-white mx-auto w-full  lg:px-8 lg:py-20">
                <div className="max-w-xl mb-6 sm:mx-auto sm:text-center md:mb-10 lg:max-w-2xl">
                  <p data-aos="fade-up" data-aos-duration="700" className=" mb-1 text-zinc-800 text-sm font-custombold tracking-wide uppercase md:mb-2">
                    New Chapter
                  </p>
                  <p data-aos="fade-up" data-aos-duration="700" className=" text-base font-customregular text-zinc-500 md:text-lg">
                ...
                <div className="grid gap-6 row-gap-2 sm:grid-cols-2 lg:grid-cols-4">
                  ...
                  <div data-aos="zoom-in-up" data-aos-duration="700" className="flex flex-col p-6 w-full h-64 mb-2 rounded-xl shadow-lg lg:h-80 xl:h-96  justify-between bg-green-100 text-black">
                  ...
                  <div data-aos="zoom-in-up" data-aos-duration="700" className="flex flex-col p-6 w-full h-64 mb-2 rounded-xl shadow-lg lg:h-80 xl:h-96  justify-between bg-sky-100 text-black">
